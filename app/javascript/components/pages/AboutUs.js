    ...
    return (
      <>
        ...
        <div className="bio">
          ...
          employed in local government until his retirement in 2007. Demetrius
          is a Florida resident and an active participant in a local javascript
          and php meetup group. He's very passionate about blockchain, non
          fungible tokens and web technologies. He is actively pursuing a career
          in web development and has gained valuable skills in react,
        ...
        <div className="bio">
          ...
          Louisiana resident and an active participant in a local javascript and
          php meetup group. He’s very passionate about his dog Cooper. He is
        ...
        <div className="bio">
          ...
          civilian work force as electronics level two assembler building
          servers at Naval Base Point Loma. Pavan is a San Diego resident and an
